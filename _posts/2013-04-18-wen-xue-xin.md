...
<a href="javascript:(document.getElementById('copyblog').style.display=='block')?document.getElementById('copyblog').style.display='none':document.getElementById('copyblog').style.display='block'">阅读那篇文章纯文本</a>
