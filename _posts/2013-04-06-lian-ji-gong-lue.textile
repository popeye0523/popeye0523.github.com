...
p. 在大学学习软件工程，专攻嵌入式开发方向，包括ARM7、ARM9、瑞萨、51等单片机的开发，以及linux、μC/OS[4]等操作系统，linux源码级内核裁剪，期间编程语言以C语言为主，毕业设计花了三个月用protel99画了两个电路图，并且印出电路板来，在网上淘硬件把它焊了出来，遗憾的是代码没有时间写了。我自己的感受是，硬件的知识，哪怕怎么看都不会有用处的38转换器，放大电路，都会让你对计算机和程序的原理更加的了解。
...
p. 回到学校读第二学位，用java写程序帮导师Alicia实现了多语平行语料库的解析和建立，导师很给力，把我放在了那篇被EI收录的论文的第三作者。
